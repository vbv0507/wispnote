  ...
  try {
    ...
    if (newTotalSize > MAX_STORAGE_BYTES) {
      return res.status(400).json({ 
        error: `Storage limit exceeded. This chat room can hold up to 10MB of attachments. Please upload larger files to Google Drive or OneDrive and share the link in the chat.` 
      });
    }
